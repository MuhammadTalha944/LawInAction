...
@section('content')
 ...
 <div class="card yellow_border shadow h-100 py-2">
    <div class="card-body">
        ...
        {!! Form::open(array('route' =>  ['blogs.update', $blog->id],'method'=>'PUT', 'enctype' => 'multipart/form-data')) !!}
        @csrf
        <div class="row">
            <h3>Edit Blog</h3>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control "  name="main_heading" value="{{$blog->main_heading}}">
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control "  name="sub_heading" value="{{$blog->sub_heading}}">
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control " rows="5"  name="blog_content">{{$blog->blog_content}}</textarea>
                </div>
            </div>
        </div>
