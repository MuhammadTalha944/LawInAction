...
<div class="jumbotron text-center" style="padding: 2% !important;">
  <h1 style="color: #ffcb07;font-weight: 800">Public Complaints Status</h1>
</div>
                ...
                <div class="card-body">
                   <blockquote class="blockquote">
                    ...
                    <p style="text-align: left;">
                        <b>By</b> : {{$complaint->name}}
                      <br>
                      <b>Gender</b> : 
                                    {{$complaint->gender}}<br>
                      <b>Country</b> : {{ $complaint->country }}<br>
                       <b>Phone No : </b>
                        {{$complaint->phone_number}}
                    </p>

                    @if($complaint->country == 'India')
                      <p style="text-align: left;"><b>State : </b>{{ $complaint->state->name }}</p>
                      <p style="text-align: left;"><b>District : </b>{{ $complaint->district->name }}</p>
                      <p style="text-align: left;"><b>Police Station : </b>{{ $complaint->police_station }}</p>
                      <p style="text-align: left;"><b>Pin Code : </b>{{ $complaint->pin_code }}</p>
                    @endif
